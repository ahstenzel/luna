...
bool VersionStringMatch(const std::string& v1, const std::string& v2, bool exact) {
	std::vector<std::string> rev1 = StringSplit(v1, ".");
	std::vector<std::string> rev2 = StringSplit(v2, ".");
	if (rev1.size() < 3 || rev2.size() < 3) return false;
